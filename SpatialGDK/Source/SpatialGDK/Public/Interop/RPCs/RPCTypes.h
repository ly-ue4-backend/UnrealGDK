...
{
public:
	TRPCBufferReceiver(PayloadWrapper<T>&& InWrapper = PayloadWrapper())
...
protected:
	TMap<Worker_EntityId, TArray<typename PayloadWrapper<T>::WrappedData>> ReceivedRPCs;
